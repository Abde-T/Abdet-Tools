        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight">
              Abde-T <span className="text-zinc-400 font-medium">Tools</span>
            </span>
          </div>
        </div>
      </header>
      ...
      <footer className="border-t border-white/5 bg-black/40 relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-zinc-300">Abde-T Tools</span>
          </div>
          <div className="text-zinc-500 text-sm">
            © {new Date().getFullYear()} Abde-T. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
